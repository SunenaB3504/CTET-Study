...
<ul class="list-disc list-inside ml-4 mb-4 space-y-2">
  ...
  <li><strong>Properties:</strong> Understanding basic properties like sides, vertices (corners), and faces. For example, a cube has 6 faces, 12 edges, and 8 vertices.</li>
        ...
        practiceQuestions: [
          ...
          {
            question: 'Which shape has only one curved surface and no edges or vertices?',
            options: ['Cube', 'Sphere', 'Cylinder', 'Cone'],
            correctAnswerIndex: 1,
            explanation: 'A sphere has only one curved surface and no edges or vertices.',
            subjectName: SubjectName.MATH,
            topicId: 'math1',
          ...
          },
          {
            ...
            options: ['1', '2', '3', '4'],
            correctAnswerIndex: 2,
            explanation: 'A cylinder has 3 faces: 2 flat circular faces and 1 curved face.',
            subjectName: SubjectName.MATH,
            topicId: 'math1',
            subTopicId: 'math1-solids',
          },
          {
            ...
            correctAnswerIndex: 1,
            explanation: 'A triangle is a two-dimensional (2D) shape.',
            subjectName: SubjectName.MATH,
            topicId: 'math1',
            subTopicId: 'math1-shapes',
          },
          ...
          {
            question: 'Which solid has a circular base and a single vertex?',
          ...
          {
            question: 'Which solid object can roll and also has flat faces?',
            options: ['Cube', 'Cylinder', 'Cone', 'Sphere'],
            correctAnswerIndex: 1,
            explanation: 'A cylinder can roll and has two flat faces.',
            subjectName: SubjectName.MATH,
            topicId: 'math1',
            subTopicId: 'math1-solids',
          },
  ...
  <li><strong>Money:</strong> Understanding currency and solving simple money-related problems.</li>
        ...
        practiceQuestions: [
          ...
          },
          {
            ...
            options: ['17', '30', '25', '20'],
            correctAnswerIndex: 1,
            explanation: '15 multiplied by 2 equals 30.',
            subjectName: SubjectName.MATH,
            topicId: 'math2',
          ...
          },
          {
            ...
            options: ['Meter', 'Kilogram', 'Litre', 'Second'],
            correctAnswerIndex: 1,
            explanation: 'Kilogram is the standard unit for measuring weight.',
            subjectName: SubjectName.MATH,
            topicId: 'math2',
            subTopicId: 'math2-measurement',
          },
          {
          ...
          {
            question: 'Which of the following is a unit of capacity?',
            options: ['Gram', 'Litre', 'Meter', 'Second'],
            correctAnswerIndex: 1,
            explanation: 'Litre is used to measure capacity (volume of liquids).',
            subjectName: SubjectName.MATH,
            topicId: 'math2',
            subTopicId: 'math2-measurement',
          },
          {
            ...
            options: ['9', '10', '12', '14'],
            correctAnswerIndex: 1,
            explanation: 'The pattern increases by 2 each time, so the next number is 10.',
            subjectName: SubjectName.MATH,
            topicId: 'math2',
          ...
          },
          {
            ...
            options: ['₹1', '₹2', '₹5', '₹10'],
            correctAnswerIndex: 3,
            explanation: '₹10 coin has the highest value among the options.',
            subjectName: SubjectName.MATH,
            topicId: 'math2',
            subTopicId: 'math2-money',
          },
          ...
          {
            question: 'Which is the correct way to organize data?',
            options: ['Randomly', 'In a table', 'In a story', 'In a picture'],
            correctAnswerIndex: 1,
            explanation: 'Data is best organized in a table for clarity and analysis.',
            subjectName: SubjectName.MATH,
            topicId: 'math2',
            subTopicId: 'math2-data',
          },
          {
            question: 'If a bottle holds 1 litre of water, how many millilitres is that?',
        ...
        practiceQuestions: [
          {
          ...
          },
            {
              ...
              correctAnswerIndex: 3,
              explanation: 'Language acquisition is most effective when the child has exposure to the language in meaningful contexts.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-acquisition',
            },
            {
              ...
              correctAnswerIndex: 3,
              explanation: 'The Direct Method excludes the use of mother tongue in the classroom.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-methods',
            },
            {
              ...
              correctAnswerIndex: 2,
              explanation: 'LSRW stands for Listening, Speaking, Reading, and Writing. Memorizing is not a core skill.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-lsrw',
            },
            {
              question: 'Which pedagogical approach best supports a multilingual classroom?',
              options: [
                'Ignoring home languages',
                'Using home languages as a resource',
                'Focusing only on the textbook',
                'Discouraging code-switching'
              ],
              correctAnswerIndex: 1,
              explanation: 'Using home languages as a resource supports multilingualism and helps bridge understanding.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-diversity',
            },
            {
              question: 'Assessment in language pedagogy should be:',
              options: [
              ...
              correctAnswerIndex: 1,
              explanation: 'Assessment should be continuous and comprehensive, covering all language skills.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-evaluation',
            },
            {
              question: 'Remedial teaching in language pedagogy involves:',
              options: [
                'Re-teaching the same content',
                'Diagnosing specific difficulties and providing targeted support',
                'Giving extra homework',
                'Ignoring errors'
              ],
              correctAnswerIndex: 1,
              explanation: 'Remedial teaching is about diagnosing difficulties and providing targeted support.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-remedial',
            },
            {
              question: 'Which method emphasizes teaching grammar rules before examples?',
              options: [
                'Inductive approach',
                'Deductive approach',
              ...
              correctAnswerIndex: 1,
              explanation: 'The deductive approach presents grammar rules before examples.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-grammar',
            },
            {
              question: 'A teacher encourages students to participate in role-plays to practice language. This supports:',
              options: [
                'Memorization',
                'Passive learning',
              ...
              correctAnswerIndex: 2,
              explanation: 'Role-plays support active, communicative learning, which is central to modern pedagogy.',
              subjectName: SubjectName.LANG1,
              topicId: 'lang1_2',
              subTopicId: 'lang1_2-strategies',
            },
        ],
      },
    ],
        ...
        practiceQuestions: [
          {
          ...
          },
            {
              ...
              options: ['जल', 'अग्नि', 'वायु', 'पृथ्वी'],
              correctAnswerIndex: 0,
              explanation: '"जल" पानी का पर्यायवाची है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-vocabulary',
            },
            {
              question: 'सही वाक्य चुनें:',
              options: ['मैं स्कूल जाता हूँ।', 'मैं स्कूल जाती हूँ।', 'मैं स्कूल जाते हूँ।', 'मैं स्कूल जाती है।'],
              correctAnswerIndex: 0,
              explanation: '"मैं स्कूल जाता हूँ।" सही वाक्य है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
            ...
            },
            {
              ...
              options: ['लड़कियाँ', 'लड़के', 'लड़कों', 'लड़कियों'],
              correctAnswerIndex: 1,
            ...
            },
            {
              ...
              options: ['डरपोक', 'मजबूत', 'साहसी', 'चतुर'],
              correctAnswerIndex: 0,
              explanation: '"बहादुर" का विलोम "डरपोक" है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-vocabulary',
            },
            {
              question: 'इस वाक्य में कौन सा शब्द संज्ञा है: "राम स्कूल जाता है"',
              options: ['स्कूल', 'जाता', 'है', 'राम'],
              correctAnswerIndex: 3,
              explanation: '"राम" इस वाक्य में संज्ञा है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-grammar',
            },
            {
              ...
              options: ['जागे', 'भागे', 'आए', 'गाए'],
              correctAnswerIndex: 0,
              explanation: '"जल्दी सोए जल्दी जागे" एक प्रसिद्ध लोकोक्ति है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-comprehension',
            },
            {
              ...
              options: ['से', 'के', 'पर', 'में'],
              correctAnswerIndex: 2,
              explanation: '"किताब पर मेज पर है" में "पर" संबंधबोधक है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-grammar',
            },
            {
              ...
              correctAnswerIndex: 3,
              explanation: '"तेजी से" एक क्रिया विशेषण है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-grammar',
            },
            {
              ...
              options: ['किताब', 'कितब', 'किताब्ब', 'कितब्ब'],
              correctAnswerIndex: 0,
              explanation: '"किताब" सही वर्तनी है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_1',
              subTopicId: 'lang2_1-grammar',
            },
...
<div class="mt-6 p-3 bg-yellow-50 rounded-md border border-yellow-200">
  ...
  <p class="text-sm text-yellow-700">Language pedagogy questions support approaches that are communicative, child-centric, and meaning-centric. The correct answer will include using language for real purposes, integrating skills, and viewing the child as an active meaning-maker. Reject options that emphasize rote memorization, teacher-centric methods, or isolating language skills.</p>
        ...
        practiceQuestions: [
          // ...existing code...
            {
              question: 'भाषा अधिगम का सबसे अच्छा तरीका क्या है?',
              options: ['नियमों का रटाव', 'अर्थपूर्ण संवाद', 'शब्दों की सूची', 'व्याकरण का अभ्यास'],
              correctAnswerIndex: 1,
              explanation: 'अर्थपूर्ण संवाद के माध्यम से भाषा अधिगम सबसे अच्छा होता है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-acquisition',
            },
            {
              question: 'शिक्षा में बहुभाषिकता को किस रूप में देखना चाहिए?',
              options: ['समस्या', 'संसाधन', 'अवरोध', 'अनदेखा करना'],
              correctAnswerIndex: 1,
              explanation: 'बहुभाषिकता को संसाधन के रूप में देखना चाहिए, न कि समस्या के रूप में।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-diversity',
            },
            {
              question: 'व्याकरण को किस प्रकार पढ़ाना चाहिए?',
              options: ['अलग से नियम', 'संदर्भ में', 'केवल रटाव', 'शब्दों की सूची'],
              correctAnswerIndex: 1,
              explanation: 'व्याकरण को संदर्भ में पढ़ाना चाहिए, न कि अलग से नियम के रूप में।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-grammar',
            },
            {
              question: 'LSRW में "S" का क्या अर्थ है?',
              options: ['शब्द', 'सुनना', 'सिखाना', 'संगीत'],
              correctAnswerIndex: 1,
              explanation: 'LSRW में "S" का अर्थ "सुनना" (Speaking) है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-lsrw',
            },
            {
              question: 'निरंतर और समग्र मूल्यांकन किसके लिए आवश्यक है?',
              options: ['केवल व्याकरण', 'सभी भाषा कौशल', 'केवल लेखन', 'केवल बोलना'],
              correctAnswerIndex: 1,
              explanation: 'निरंतर और समग्र मूल्यांकन सभी भाषा कौशल के लिए आवश्यक है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-evaluation',
            },
            {
              question: 'पुनरावृत्ति शिक्षण (Remedial Teaching) का उद्देश्य क्या है?',
              options: ['फिर से वही पढ़ाना', 'विशिष्ट कठिनाइयों का निदान और समाधान', 'अतिरिक्त गृहकार्य', 'त्रुटियों को अनदेखा करना'],
              correctAnswerIndex: 1,
              explanation: 'पुनरावृत्ति शिक्षण का उद्देश्य विशिष्ट कठिनाइयों का निदान और समाधान है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-remedial',
            },
            {
              question: 'शिक्षक द्वारा भूमिका-निर्वाह (Role-play) करवाने का मुख्य उद्देश्य क्या है?',
              options: ['रटाव', 'सक्रिय संवाद', 'केवल लेखन', 'शब्दों की सूची'],
              correctAnswerIndex: 1,
              explanation: 'भूमिका-निर्वाह (Role-play) सक्रिय संवाद को बढ़ावा देता है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-strategies',
            },
            {
              question: 'शिक्षण सामग्री (TLM) का प्रयोग किसलिए किया जाता है?',
              options: ['केवल दिखाने के लिए', 'अर्थपूर्ण अधिगम के लिए', 'रटाव के लिए', 'अनदेखा करने के लिए'],
              correctAnswerIndex: 1,
              explanation: 'शिक्षण सामग्री का प्रयोग अर्थपूर्ण अधिगम के लिए किया जाता है।',
              subjectName: SubjectName.LANG2,
              topicId: 'lang2_2',
              subTopicId: 'lang2_2-tlm',
            },
        ],
      },
    ],
