...
export const QUESTION_PAPER_JAN_24_II: QuestionPaper = {
  ...
  description: 'Complete question paper for CTET January 2024 Paper II (Classes 6-8)',
  paperType: PaperType.PAPER_II,
  questions: [
    // Child Development & Pedagogy (Q1-30)
    {
      question: "[Question 1 - Manual entry needed from Qus-Jan-24.pdf]",
      options: ["[Option 1]", "[Option 2]", "[Option 3]", "[Option 4]"],
      correctAnswerIndex: 0,
      explanation: "[Extract from Anz-Jan-24.pdf - Explanation needed with NCF 2005 reference]",
    ...
    // Science OR Social Studies (Q91-150) - 60 questions total
    {
      ...
      options: ["[Option 1]", "[Option 2]", "[Option 3]", "[Option 4]"],
      correctAnswerIndex: 0,
      explanation: "[Extract from Anz-Jan-24.pdf - Science/Social Studies explanation with NCF 2005]",
