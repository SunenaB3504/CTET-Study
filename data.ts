export const lang2PracticeQuestions: MCQ[] = [
  {
    question: "निम्नलिखित में से कौन सा एक उपमा का उदाहरण है?",
    options: ["चाँदनी रात में तारे नाच रहे थे।", "बिल्ली चुपचाप बैठी थी।", "वह शेर की तरह बहादुर है।", "वह हवा की तरह दौड़ता है।"],
    correctAnswerIndex: 2,
    explanation: "उपमा में 'जैसे' या 'की तरह' का उपयोग करके तुलना की जाती है, जैसे 'वह शेर की तरह बहादुर है।'",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_2",
    subTopicId: "lang2_2-upma",
  },
  {
    question: "पाठ को जल्दी से पढ़कर मुख्य विचार प्राप्त करने की प्रक्रिया को क्या कहते हैं?",
    options: ["सभी विवरण समझना", "मुख्य विचार प्राप्त करना", "पाठ को याद करना", "व्याकरण का विश्लेषण करना"],
    correctAnswerIndex: 1,
    explanation: "पाठ को जल्दी से पढ़कर मुख्य विचार प्राप्त करने की प्रक्रिया को स्किमिंग कहते हैं।",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_3",
    subTopicId: "lang2_3-skimming",
  },
  {
    question: "निम्नलिखित में से कौन सा मानवीकरण का उदाहरण है?",
    options: ["हवा ने पेड़ों के बीच फुसफुसाया।", "लड़का तेज दौड़ा।", "वह जिराफ की तरह लंबी है।", "कार लाल है।"],
    correctAnswerIndex: 0,
    explanation: "मानवीकरण में निर्जीव वस्तुओं को मानव गुण दिए जाते हैं, जैसे 'हवा ने पेड़ों के बीच फुसफुसाया।'",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_4",
    subTopicId: "lang2_4-manvikan",
  },
  {
    question: "'दयालु' शब्द का विलोम क्या है?",
    options: ["दयालु", "क्रूर", "उदार", "सहानुभूतिपूर्ण"],
    correctAnswerIndex: 1,
    explanation: "'दयालु' का विलोम 'क्रूर' है, क्योंकि उनके अर्थ विपरीत हैं।",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_5",
    subTopicId: "lang2_5-vilom",
  },
  {
    question: "निम्नलिखित में से कौन सा एक मुहावरे का उदाहरण है?",
    options: ["बर्फ तोड़ना", "सूरज गर्म है", "वह लंबी है", "कार तेज है"],
    correctAnswerIndex: 0,
    explanation: "मुहावरा एक ऐसा वाक्यांश है जिसका अर्थ उसके शाब्दिक अर्थ से अलग होता है, जैसे 'बर्फ तोड़ना।'",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_6",
    subTopicId: "lang2_6-muhavara",
  },
  {
    question: "'समानार्थी' शब्द का अर्थ क्या है?",
    options: ["एक ही अर्थ वाला शब्द", "विपरीत अर्थ वाला शब्द", "अनेक अर्थ वाला शब्द", "कोई अर्थ नहीं वाला शब्द"],
    correctAnswerIndex: 0,
    explanation: "समानार्थी वह शब्द है जिसका अर्थ किसी अन्य शब्द के समान या लगभग समान होता है।",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_7",
    subTopicId: "lang2_7-samanarthi",
  },
  {
    question: "निम्नलिखित में से कौन सा वाक्य निष्क्रिय वाक्य में है?",
    options: ["वह एक किताब पढ़ रही है।", "एक किताब उसके द्वारा पढ़ी जा रही है।", "वह किताबें पढ़ती है।", "वह एक किताब पढ़ेगी।"],
    correctAnswerIndex: 1,
    explanation: "निष्क्रिय वाक्य में कर्ता क्रिया प्राप्त करता है, जैसे 'एक किताब उसके द्वारा पढ़ी जा रही है।'",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_8",
    subTopicId: "lang2_8-nishkriya",
  },
  {
    question: "एक अनुच्छेद में मुख्य वाक्य का उद्देश्य क्या है?",
    options: ["अनुच्छेद को समाप्त करना", "मुख्य विचार प्रस्तुत करना", "उदाहरण प्रदान करना", "अनुच्छेद का सारांश देना"],
    correctAnswerIndex: 1,
    explanation: "मुख्य वाक्य अनुच्छेद के मुख्य विचार को प्रस्तुत करता है और सहायक वाक्यों के लिए स्वर निर्धारित करता है।",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_9",
    subTopicId: "lang2_9-mukhya-vakya",
  },
  {
    question: "निम्नलिखित में से कौन सा अनुप्रास का उदाहरण है?",
    options: ["कच्चा पपीता पकने पर पीला पड़ता है।", "बिल्ली चुपचाप बैठी थी।", "वह शेर की तरह बहादुर है।", "तारे चमक रहे हैं।"],
    correctAnswerIndex: 0,
    explanation: "अनुप्रास में एक ही प्रारंभिक व्यंजन ध्वनि की पुनरावृत्ति होती है, जैसे 'कच्चा पपीता पकने पर पीला पड़ता है।'",
    subjectName: SubjectName.LANG2,
    topicId: "lang2_10",
    subTopicId: "lang2_10-anupraas",
  },
];
